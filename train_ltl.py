...
ENVS = [
    ("MiniGrid-Empty-8x8-v0",    LTLEmptyWrapper,   "empty"),
    ("MiniGrid-LavaGapS5-v0",    LTLLavaGapWrapper, "lava"),
    ("MiniGrid-DoorKey-8x8-v0",  LTLDoorKeyWrapper, "doorkey"),
]

for env_id, WrapperClass, name in ENVS:
    print(f"\n{'='*50}")
    print(f"Training on: {env_id} with LTL wrapper")
    print(f"{'='*50}")
